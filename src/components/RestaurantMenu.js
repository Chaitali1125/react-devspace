        ...
        : (
            <>
                {resInfo.map((resMenu, resIndex) => {
                    ...
                    console.log(resMenu?.card?.info);
                    return (
                        <div className='outer-card px-4 ' key={id}>
                            <div className='menu-items grid gap-2 m-4 rounded-lg p-4 border border-gray-200'>
                                <div className='restaurant-menu' >
                                    <div>
                                        ...
                                        <h3>12456</h3>
                                        {/* <h3>{variantsV2.variantGroups[1]?.variations[0]?.price}</h3> */}
                                        <div className='flex items-center'>
                                            ...
                                            <div className='flex'><h4 className='text-green-800 font-medium'>{ratings?.aggregatedRating?.rating}</h4></div><h4>({ratings?.aggregatedRating?.ratingCountV2})</h4>
                                        </div>
                                        <h5>{description}</h5>
                                    </div>
                                    <div>
